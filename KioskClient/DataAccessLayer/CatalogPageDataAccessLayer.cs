        ...
        public List<Movie> GetMovies()
        {
            return new List<Movie>
            {
                MovieBuilder.Create()
                    ...
                    .WithAgeLimit(16)
                    .WithDuration(108)
                    .WithPlot("Наконец-то изобретена машина, которая позволяет избавиться от любых воспоминаний. Джоэль и Клементина решают выбросить друг друга из головы. Но в памяти Джоэля все еще живы самые нежные моменты их чувства. Чем меньше он помнит, тем больше любит.\n\nПонимая, что он просто обожает Клементину, Джоэль пытается найти способ, чтобы вернуть любимой память о прошлом. Пока еще не очень поздно… Он должен победить ненавистный компьютерный мозг во что бы то ни стало!")
                ...
                MovieBuilder.Create()
                    ...
                    .WithDuration(113)
                    .WithAgeLimit(16)
                    .WithPlot("По сюжету главная героиня родилась вместе с XX веком и живет на свете уже сто лет, но при этом не стареет. Несмотря на свою долгую жизнь, Адалин так и не смогла найти любимого человека. Однако наконец-то она встречает мужчину, ради которого сможет снова стать смертной и состариться вместе с ним.")
